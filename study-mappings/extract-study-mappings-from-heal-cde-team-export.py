...
def extract_study_mappings(input_file, output, study_to_hdpid, measure_to_heal_cde_id):
    ...
    header_crf_mappings = {
        ...
        "Pain Interference (choice=BPI Pain Interference (Copyrighted) (for acute pain))": "NA",
        ...
        "Substance Use Screener (choice=TAPS 1)": "NA",
        ...
        "Pain Interference (choice=BPI Pain Interference (Copyrighted))": "NA",
        "Sleep (choice=AWS-10 + Sleep Duration Items)": "NA",
        ...
        "Prescription Opioid Use (choice=Compute Opioid MME using either the REDCap Data Dictionary in the HEAL CDE repository or the web tool)": "opioid-mme",
        "PedsQL Inventory Age Range(s) (choice=2-4 year old)": "NA",
        "PedsQL Inventory Age Range(s) (choice=5-7 year old)": "NA",
        "PedsQL Inventory Age Range(s) (choice=8-12 year old)": "NA",
        "PedsQL Inventory Age Range(s) (choice=13-18 year old)": "NA",
